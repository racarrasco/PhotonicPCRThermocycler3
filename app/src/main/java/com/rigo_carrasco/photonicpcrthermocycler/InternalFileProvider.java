...
/**
 * Created by Rigo_Carrasco on 10/17/2016. The class that allows for files to be sent to
 * email
 */
public class InternalFileProvider extends ContentProvider {
    public static final String AUTHORITY = "com.rigo_carrasco.photonicpcrthermocycler.provider";
